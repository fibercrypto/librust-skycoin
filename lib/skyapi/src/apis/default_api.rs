...
pub trait DefaultApi {
    ...
    fn address_uxouts(&self, address: &str) -> Box<Future<Item = Vec<Value>, Error = Error<serde_json::Value>>>;
    ...
    fn data_get(&self, _type: &str, key: &str) -> Box<Future<Item = Value, Error = Error<serde_json::Value>>>;
    ...
    fn resend_unconfirmed_txns(&self, ) -> Box<Future<Item = Value, Error = Error<serde_json::Value>>>;
    ...
    fn transaction_verify(&self, transaction_verify_request: ::models::TransactionVerifyRequest) -> Box<Future<Item = Value, Error = Error<serde_json::Value>>>;
    ...
    fn verify_address(&self, address: ::models::Value) -> Box<Future<Item = Value, Error = Error<serde_json::Value>>>;
    ...
    fn wallet_transaction(&self, wallet_transaction_request: ::models::WalletTransactionRequest) -> Box<Future<Item = Value, Error = Error<serde_json::Value>>>;
    ...
    fn wallets(&self, ) -> Box<Future<Item = Vec<Value>, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>DefaultApi for DefaultApiClient<C> {
    ...
    fn blocks(&self, start: i32, end: i32, seq: Vec<i32>) -> Box<Future<Item = ::models::InlineResponse2001, Error = Error<serde_json::Value>>> {
        __internal_request::Request::new(hyper::Method::Get, "/api/v1/blocks".to_string())
            ...
            .with_query_param("seq".to_string(), seq.join(",").to_string())
            .execute(self.configuration.borrow())
    }
